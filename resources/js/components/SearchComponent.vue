    ...
    <div>
        <div class="input-group d-flex justify-content-center">
            <div class="form-outline">
                <input v-model="search" type="search" id="form1" class="form-control uneditable-input-bg"/>
            </div>
            <button type="button" class="btn  btn-dark" @click="searchDetails">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#5D0505FF" class="bi bi-search" viewBox="0 0 16 16">
